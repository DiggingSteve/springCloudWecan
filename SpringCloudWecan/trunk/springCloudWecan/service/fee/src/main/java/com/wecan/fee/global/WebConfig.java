...
public class WebConfig implements WebMvcConfigurer {
    ...
    public class IntegerToBooleanDeserializer extends JsonDeserializer<Integer> {
        @Override
        public Integer deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
            Boolean s = jsonParser.getValueAsBoolean();
            if (s) return 1;
            else return 2;
        }
    }

    public class InterToBooleanSerializer extends JsonSerializer<Integer> {

        @Override
        public void serialize(Integer aInt, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
            if (aInt == 1) {
