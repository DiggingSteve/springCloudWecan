  ...
  <div>
    ...
    <!-- <commonTabs :list="tabsList" :showExpanionBtn="false" :checkedIndex.sync="tabChecked" :showTooltip="false"
      ...
      <div class="fdinformation">
        <!-- <h1>{{cargoIndex.cargoIndexStatus}}测试</h1>
         -->

         
          <new-form-cmpt :view-data="mawbdetail.opersystem == '进口' ? orderViewData : hawbViewData" :model-data="hawbdata" @changeRelData="mawbdetail.hawbList[computedTabIndex].customerRelList = $event">
          </new-form-cmpt>
