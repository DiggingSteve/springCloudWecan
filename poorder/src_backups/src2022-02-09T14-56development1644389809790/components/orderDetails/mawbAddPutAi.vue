        ...
        <div class="mawbAddPut" v-if="!newMawbShow" :ordertype="ordertype" :pagetype="pagetype">
            ...
            >拆分</el-button> -->
                        ...
                        <el-button btnnum="109" type="primary" @click="printDz" v-if="btnJurisdic(109)">预付通知单
                         ...
                         <el-button btnnum="115" type="primary" @click="lxdDialogShow=true" v-if="btnJurisdic(115)">海关联系单
                        </el-button>
                                         ...
                                         <div class="detail"
                                            ...
                                            <div class="detail-c"
                                                ...
                                                <new-form-cmpt :view-data.sync="zdBasicInfoSave"
                                                    :model-data.sync="inputModelData" :pagetype="2"></new-form-cmpt>
                                            </div>
                                        </div>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                hasServiceContent:['AA0410', 'AA0510', 'AA0610', 'AG0145', 'AG0150', 'AA0110', 'AA0120','AA0130','AA0140', 'AA0150', 'AA0310', 'AA0320', 'AA0230', 'AA0240', 'AG0110', 'AG0115', "AG0120", "AG0140", "AA0810", "AA0830", "AA0840", "AA0850", "AG0125", "AG0130", "AG0135", "AB0420", "AB0520", "AB0620"], //存在服务内容的
                cgportTtabs:[
        ...
        methods: {
            ...
            getPortChildren(port){//获取该服务模块下选中的服务，还要过滤到总单制单AA0110和分单制单AA0120
              return  this.inputModelData.serviceList.filter(i=> this.newService[i.servicecode]&&this.newService[i.servicecode].port==port&&i.isdel==1&&!['AA0110','AA0120'].includes(i.servicecode)).map(i=>i.servicecode)           
            },
            refreshPeihuo() {
                this.getMawbdetail()
                ...
                await this.$axios({
                    ...
                    if (data.opersystem == "国内服务") {
                        ...
                        if (data.orderdom == "直单") {
                            data.zdweight =
                                data.zdweight ||
                                (data.realweight && Number(data.realweight).toFixed(2));
                            data.zdvolume =
                                data.zdvolume ||
