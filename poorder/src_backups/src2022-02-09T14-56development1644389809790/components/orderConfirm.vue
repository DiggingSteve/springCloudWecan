<template>
  <div>
    ...
    <el-dialog title="综合查询" v-if="dialogShow" center :visible.sync="dialogShow" class="dialogPage"
      ...
      <mawbaddput :visible.sync="dialogShow" :pagetype='6' :mawbguid="mawbguid" :boguid="boguid" :area="area"
        :orderdom="orderdom" @update="delTableIndex" :pageFrom="'order'"></mawbaddput>
    </el-dialog>
          ...
          <formCompt :input-view-data="shipaceInfo" :input-model-data="shipaceInfoData">
            ...
            <template slot="qfsj">
              ...
              <i title="航班维护" class="el-icon-edit-outline" @click="qfsjDialogFunc(2)"
                style="font-size:20px;color:#30C76C;cursor:pointer;position:relative;top:4px;"></i><i title="刷新"
                class="el-icon-refresh" @click="getQfsj(2)"
  ...
  export default {
    ...
    data() {
      return {
        ...
        shipaceInfo: [//配舱
          ...
          { "title": "配舱操作：", id: "czlx", type: 3, "model": "", "defaultModel": "唯凯配舱", options: [], width: 100, class: 'allwidth', groupid: '132' },
    ...
    methods: {
      ...
      reset() {
        ...
        this.inputModelData = { "status": "AO5040", "dzstatus": "AO0020,AO0022" }
