<template>
  <div class="ownSubmissionStl">
    ...
    <tableCompt :name="name" :table-data-res="tableDataRes" :nestedTableType="2" v-on:transmitMsg="getZimessage" :ziTableData="ziTableData"  showZiConfig :chinese-where.sync="chineseWhere">
   ...
   <el-dialog :visible.sync="dialogShow" class="dialogPage" :close-on-click-modal="false" v-if="dialogShow" width="100%"
  :modal="false" top="0" title="未提交结算(外站订单)" center>
...
this.tableDataRes=[]
this.searchData.orderguid={"unequal":"-1"}
