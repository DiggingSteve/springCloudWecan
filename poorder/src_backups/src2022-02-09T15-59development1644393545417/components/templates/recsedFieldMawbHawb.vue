  ...
  <div style="position:relative;display:inline-block">
    ...
    <div @click.stop=";">
      <el-input v-model.trim="tableDataName" @focus="hawbShuJu" @keyup.native.stop="filter2" @blur="clearNowValue"
        style="width:280px;" :placeholder="type=='2'?'收货人查询':'发货人查询'" :disabled="disabled">
        <i slot="prefix" class="el-input__icon el-icon-search" style="margin-top:-5px;"></i>
      </el-input>
      <el-button style="margin-left:10px;" @click="saveFunc" v-show="!hideBtn" :disabled="disabled">保存</el-button>
      <el-button style="margin-left:10px;" @click="assignmentData()" v-show="!hideBtn" :disabled="disabled">清除</el-button>
    </div>
