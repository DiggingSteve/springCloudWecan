        ...
        <div class="sfd">
          ...
          <div class="content">
            ...
            <div class="jchz" v-show="sfdtabs == '货站'">
              ...
              <div>
                <span>港口：</span>
                <pageSelect :pagetype="6" :modelval.sync="inputModelData.port_thr" class="input-required" style="width: 186px;display:inline-block;"></pageSelect>
              </div>
              ...
              <div>
                ...
                <el-select v-model="inputModelData.terminal_thr" class="input-required">
                  <el-option
                    ...
                    v-if="option.sfg == inputModelData.port_thr"
                    :key="index"
                    :value="option.cname">
                  </el-option>
                </el-select>
        ...
        <div class="mdd">
          ...
          <div class="content">
            ...
            <div class="jchz" v-show="mddtabs == '货站'">
              ...
              <div>
                <span>港口：</span>
                <pageSelect :pagetype="6" :modelval.sync="inputModelData.port_shr" class="input-required" style="width: 186px;display:inline-block;"></pageSelect>
              </div>
              ...
              <div>
                ...
                <el-select v-model="inputModelData.terminal_shr" class="input-required">
                  <el-option
                    v-for="(option, index) in cargo_station_option"
                    v-if="option.sfg == inputModelData.port_shr"
                    :key="index"
                    :value="option.cname">
                  </el-option>
                </el-select>
...
export default {
  ...
  computed: {
     sfdtabs:{
            ...
            set(val){
                   this.inputModelData.address_thrtype_org=this.address_type.indexOf(val) + 1
            }
     },
     mddtabs:{
            get(){
            ...
            set(val){
                    this.inputModelData.address_shrtype_org=this.address_type.indexOf(val) + 1
            }
     },
    thrAddressData: {
      get () {
  ...
  methods: {
    ...
    saveAddress () {
      //新增保存里面的地址
/*       console.log('address_thrtype_org'+this.inputModelData.address_thrtype_org )
      console.log('address_shrtype_org'+this.inputModelData.address_shrtype_org ) */
    ...
    // if(!this.inputModelData.lxr_thr_org || !this.inputModelData.phone_thr_org|| !this.inputModelData.lxr_shr_org || !this.inputModelData.phone_shr_org){
    //        this.$message.error('请填写提货服务的完整信息')
    //       return false
    //     }

      if (this.sfdtabs == '客户地址') {

           if (!this.inputModelData.company_thr_org ) {
          this.$message.error('请填写提送货服务的完整信息')
          return false
        }
        ...
        if (!this.$refs.thraddress.checkInputRequired()) {
          return this.$message.error('请填写提送货服务的完整信息')
        }
   ...
   /*      if ( this.inputModelData[this.id].length == 0) {
      ...
      if (this.mddtabs == '客户地址') {
            if (!this.inputModelData.company_shr_org ) {
                this.$message.error('请填写提送货服务的完整信息')
                return
            }
