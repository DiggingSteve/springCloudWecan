<template>
    ...
    {{opertype}} -->
        ...
        <div class="page-container-box">
            <newSearchComp :name="name" :realPageName="monitor?realname:realPageName" :view-data.sync="inputViewData"
    ...
    export default {
        ...
        computed: {
            ...
            pagetype() {
                ...
                if(!this.monitor){
                    let type = ["listConfirmOut", "orderTaking", "orderTakingOverDate", 'cabinUnconfirmed'].indexOf(this.realPageName) + 1;

                    if (this.realPageName == "orderTakingOverDate") {
                        type = JSON.parse(sessionStorage.nav).find(i => i.id == this.$route.params.id).autcode == "SH_POMANAGEMENT_PAGE_ORDERTAKINGOVERDATELOCAL" ? 5 : 3
                    }
