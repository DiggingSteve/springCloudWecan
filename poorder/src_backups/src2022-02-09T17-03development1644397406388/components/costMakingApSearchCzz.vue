<template>
  <div>
    ...
    <el-dialog
      title="费用未确认"
      :visible.sync="costMakingApp"
      width="100%"
      top="0"
      v-if="costMakingApp"
      @close="costMakingApp=false"
      :close-on-press-escape="false"
      class="dialogPage"
      :modal="false"
      center
    >
      <costmaking :mawbguid="mawbguid" :boguid="boguid"></costmaking>
      <!-- <span slot="footer">
...
export default {
  ...
  name: "costMakingApSearchCzz",
  components: {},
  data() {
    return {
      name: "costMakingApSearchCzz.vue",
      costMaking: false,
  ...
  methods: {
    search() {
      ...
      //search.commitstatus={'in':'100,200'}
      ...
      var json = { json: JSON.stringify(jsonArr2), ordertype: "oper" };
    ...
    openDialog(indexData) {
      ...
      this.committype = this.tableDataRes[indexData].commitstatus;
