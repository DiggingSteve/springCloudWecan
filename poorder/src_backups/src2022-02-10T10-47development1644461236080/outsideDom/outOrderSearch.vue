<template>
  <div>
    ...
    <tableCompt :name="name" :table-data-res="tableDataRes" :nestedTableType="2" @transSelIndex="openDialog"
      ...
      :chinese-where="chineseWhere" showZiConfig  @wageConfirmStatus="openDialog2">
    ...
    <transition enter-active-class="animate__animated animate__zoomInDown"
      ...
      <el-dialog title="综合查询" center :visible.sync="dialogShow" v-if="dialogShow" class="dialogPage"
        ...
        <mawbaddput :visible.sync="dialogShow" :pagetype="21" :mawbguid="mawbguid" :boguid="boguid" :area="area"
          :orderdom="orderdom" @update="delTableIndex" @success="mergeSuc"></mawbaddput>
      </el-dialog>
...
<script>
  ...
  import {  getChangeValue, computedWeight, formatDate } from '@/outsideDom/api/sessionStorage.js'
