...
export default {
  name: "costConfirmationCancel",
  mixins: [systemCheck, openZimessage],
  components: {},
  data() {
    return {
      name: "costConfirmationCancel.vue",
      costMaking: false,
  ...
  methods: {
    search() {
      ...
      this.$axios({
        method: "get",
        url: this.$store.state.webApi + "api/ExHpoboAxplineWageConfirm",
        params: json,
        loading: true,
        tip: true
      })
