<template>
  <div>
    ...
    <tableCompt name="outOrderSearch.vue" :table-data-res="tableDataRes" :nestedTableType="2"
      @transSelIndex="openDialog" v-on:transmitMsg="getZimessage" @transmitZiMsg="transmitZiMsg"
      :ziTableData="ziTableData" :chinese-where="chineseWhere" showZiConfig 
    ...
    <transition enter-active-class="animate__animated animate__zoomInDown"
      ...
      <el-dialog title="综合查询" center :visible.sync="dialogShow" v-if="dialogShow" class="dialogPage"
        ...
        <!-- <outMawbAdd :pagetype="2" :boguid="boguid" frompage="4" @success="dialogShow=false;search()">
        </outMawbAdd> -->

        <newOrderAdd :pagetype="2" :boguid="boguid" frompage="4" @success="dialogShow=false;search()">
        </newOrderAdd>
      </el-dialog>
    </transition>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        inputModelData: {
          ...
          // dzstatus: "AO0010,AO0020",
          status:"AO5010,AO5020"
        },
    ...
    created() {
      ...
      // this.$nextTick(() => {
      //   if (this.inputViewData.dzstatus) {
      //     this.$set(this.inputViewData.dzstatus, 'disabled', true)
      //   }
      // })
