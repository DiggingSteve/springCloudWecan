...
<!-- {{comContact}} -->
    ...
    <div class="rel-title">
      ...
      <pageSelect pagetype="9" v-show="activeLxrss == 1&&pagetype==2" :modelval.sync="comContact" @change="addNewCon" style="width:180px;display:inline-block;float:right" placeholder='添加我司联系人'></pageSelect>
    </div>
    <!-- {{activeLxrss}} -->
