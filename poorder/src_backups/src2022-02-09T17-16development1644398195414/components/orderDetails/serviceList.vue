            ...
            if (item.dom == "总单") {
              if (serviceList.length == 0) {
                ...
                this.$set(this.newService, item.servicecode, {
                  ...
                  //  model:false,
                  oprequest: "",
                  disabled: (this.orderdom == '直单' && item.servicecode == 'AA0120') || item.servicecode == 'AA0150' || item.servicecode == 'AA0140',
                ...
                if (item.servicecode == "OA0010" || item.servicecode == 'AA0150' || item.servicecode == 'AA0140') {
                  disabled = true;
                }
