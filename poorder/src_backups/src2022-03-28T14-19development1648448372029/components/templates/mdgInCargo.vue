          ...
          <el-row>
            <!-- <el-col :span="7">
              ...
              <span class="input-required">
              	<el-select v-model="sfg.yjstorearea_mdg"  @change="changeArea(sfg.yjstorearea_mdg)">
                <el-option
                  v-for="item in area"
                  :key="item"
                  :label="item"
...
<!-- <el-col :span="7">
             ...
             <span class="input-required">
              ...
              <span class="input-required" style="width:220px;">
              	<el-input v-model="mdg.yjstoredays_mdg" style="width:220px;"></el-input>
              	<!-- <el-select v-model="sfg.yjstorearea_mdg"  @change="changeArea(sfg.yjstorearea_mdg)">
                <el-option
                  v-for="item in area"
                  :key="item"
      ...
      <el-col :span="7">
              <span >其他备注：</span>
              <span class="input-required" style="width:220px;">
              	<el-input v-model="mdg.remark_mdg" style="width:220px;"></el-input>
               </span>
               </el-col>
...
<!-- <el-col :span="7">
             <span>入库仓库：</span>
              ...
              <span class="input-required">
                <el-select v-model="sfg.yjstore_mdg"  @change="changeArea(sfg.yjstore_mdg)">
                <el-option
