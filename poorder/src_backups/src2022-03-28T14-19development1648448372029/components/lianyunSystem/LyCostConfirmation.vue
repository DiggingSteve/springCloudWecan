<template>
  <div class="LyCostConfirmation">
    ...
    <el-dialog
      ...
      <LyCostMaking :id="cur_order_id" :guid="cur_guid"></LyCostMaking>
...
<script>
import LyCostMaking from './LyCostMaking'

export default {
  name: 'LyCostConfirmation',
  components: {
    LyCostMaking
  },
  data () {
  ...
  methods: {
    ...
    search () {
      ...
      this.$axios({method:'get',url:this.$store.state.webApi+'api/ExTransport/SelectTransport',params:json,loading:true,tip:false})
      .then(results=>{
