          ...
          <div class="field-container">
            ...
            <div class="sort-field">
              <div class="sort-title-c">
                <h3 :class="['sort-title',{active: activeLib == '3'}]" @click="activeLib = '3';highlightFieldIndex = ''">运价</h3>
  ...
  data () {
    return {
      ...
      allTableTmpField2: { // 国内订单字段
        ...
        detail:{ title: '运价详情', fieldtype: 3 },
        remark:{ title: '备注', fieldtype: 3 },
        routing:{title: 'routing', fieldtype: 3 }  ,
        realwtkhname:{title:"委托客户",fieldtype:3},
