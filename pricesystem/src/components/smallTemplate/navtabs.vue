<template>
    <div class="tabNav">
        <div class="tabNavConter">
            ...
            <div class="tabnavcon">
                    <router-link :to="{name:item.temp,params: {id: item.text,ready08:item.ready08}}" replace v-for="(item,index) in tabRel"
    ...
    export default {
        ...
        methods: {
            ...
            toggleZiNav: function (val) {
                ...
                // let ready08=curNav.ready08
                let {temp,autname,othername,ready08}={...curNav}
