...
export default {
 ...
 // 查找当前格子一口价
      ...
      if (weight.title == "MIN") {
        ...
        return  matchWeight.standardPrice == 0
          ? "--"
          : (matchWeight.standardPrice / this.currentCurrency).toLocaleString();
      }
      var val=((matchWeight.standardPrice+volDiff+packageDiff+cusDiff)/this.currentCurrency).toLocaleString();
