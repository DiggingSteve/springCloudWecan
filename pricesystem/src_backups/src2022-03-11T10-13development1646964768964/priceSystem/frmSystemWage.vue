  ...
  <div class="frm-system-wage">
    <div class="page-container-box">
      ...
      <div class="searchForm">
        ...
        <el-button type="primary" @click="addWage"   :disabled="componentName === 'AISOUT' || componentName === 'AISIN'" >杂费新增</el-button>
      </div>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      inputViewData: {
        wagestandard: { title: '标准', type: 4, options: [{ label: '唯凯标准', value: '唯凯标准' }] },
  ...
  watch: {
    ...
    '$route'(val){
      ...
      switch (val.params.ready08) {
        case 'AEWIN' :
          ...
          this.componentStatus = "空出"
           this.inputModelData = {}
          //  this.tableDataRes = []
           this.wageDialogVisible = false
           this.inputViewData.wagestandard.options.splice(0,this.inputViewData.wagestandard.options.length)
           this.inputViewData.wagestandard.options.push({ label: '客户标准', value: '客户标准' })
           this.inputViewData.wagestandard.options.push({ label: '唯凯标准', value: '唯凯标准' })
        break
        case 'AESIN' :
        ...
        case 'AIWOUT' :
          ...
          this.componentStatus = "空进"
          this.inputViewData.fid.title = '供应商'
          this.inputModelData = {}
          // this.tableDataRes = []
          this.wageDialogVisible = false
          this.inputViewData.wagestandard.options.splice(0,this.inputViewData.wagestandard.options.length)
          this.inputViewData.wagestandard.options.push({ label: '供应商标准', value: '供应商标准' })
    ...
    inputModelData: {
      deep: true,
      handler (val) {
        if (val.wagestandard === '客户标准' || val.wagestandard === '供应商标准') {
  ...
  methods: {
    ...
    search (isNewWage) {
      ...
      if(this.$router.history.current.params.ready08 === 'AIWOUT'  || this.$router.history.current.params.ready08 === 'AISOUT'){
          this.searchData.wageinout = 2
        } else {
          this.searchData.wageinout = 1
        }
    ...
    openWageDialog (row) {
      ...
      if (row.wagestandard.includes('客户标准') || row.wagestandard.includes('供应商标准')) {
