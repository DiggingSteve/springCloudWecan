...
//window.queueObj=new SystemMessage();
  export default {
        ...
        system_list: [
          {
            ...
            title: '基础信息', bg: './boStatic/images/login/system_bg4.png', icon: './boStatic/images/login/system_icon4.png', sub: [
             ...
             //暂时隐藏之后和运价系统合并 { system_name: '价格管理', href: '${location.hostname}/priceManagement/#/index' },
              // 运价系统暂定路由
              { system_name: '价格管理', href: '${pathname}/priceSystem.html#/index?redirect=priceFreight' },
              { sub_title: '分站' },
            ...
            title: '审批管理', bg: './boStatic/images/login/system_bg5.png', icon: './boStatic/images/login/system_icon5.png', sub: [
              ...
              { system_name: '信控审批', href: '${location.hostname}/wffmanagement?username=${username}&key=${key}&defaulturl=业务信用审批' },
    ...
    //   self.spanOpen({ system_name: '唯凯订单', href: 'index.html#/index?openKey=true' })
    // })
