    ...
    <div>
        ...
        <div class="gooodstable">
            ...
            <div v-for="(curObj,indexkhjcno) in inputModelData.ybstoreList" class="gooodstable-row" v-enterfocus>
                ...
                <div>
                    <el-select v-model="curObj.storename_yb" v-if="curObj.storeType=='晚入库'||curObj.storeType=='入库'"
                    ...
                    <span v-else>
                        <el-input v-model="curObj.storename_yb"  placeholder=""></el-input>
                    </span>
                </div>
                <div>
        ...
        <!-- 
        <div v-enterfocus class="enterWarehouseNumber" v-if="!isOutsideSystem">
